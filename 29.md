...
- *group base gift wrap message* (`kind:1060`)

Similar to `kind:1059`, this is the gift wrap message that sended to a group. With this, users can wrap and send many other messages to a group, such as *Private Direct Messages*.
